 ...
 * @param {boolean} props.disabled - The disable property of the button. Default is false.
 ...
 */
export default function Button({ children, color, onClick, disabled=false, type="button" }) {
  /**
