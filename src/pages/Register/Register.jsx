...
export default function Register() {  
  ...
  const handleRegister = async (e) => {
    ...
    const success = await register(first_name, last_name, university, email, password)
  ...
  return (
    <section className="register">
      <form onSubmit={handleRegister}>
        ...
        <p>Already have an account? <Link class="text-blue-700" to="/login">Login Here</Link></p>
      </form>
    </section>
  )
}